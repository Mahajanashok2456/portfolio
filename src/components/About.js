...
export default function About() {
  return (
    <section id="about" className="py-20 md:py-32 bg-black border-t border-white/5 overflow-hidden">
      <div className="max-w-[1440px] mx-auto px-6 md:px-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            <h2 className="text-[0.6rem] font-black text-white/40 uppercase tracking-[0.4em] mb-4 md:mb-6">About Me</h2>
            <h3 className="text-4xl md:text-8xl font-black text-white mb-8 md:mb-10 leading-[1.1] md:leading-[0.9] tracking-tighter uppercase whitespace-pre-line">
            ...
            <div className="space-y-6 md:space-y-8 text-base md:text-xl text-white/60 leading-relaxed font-medium max-w-xl mx-auto lg:mx-0">
              <p>
                Innovative AI Engineer and Full Stack Developer specializing in <span className="text-white">FastAPI</span>, <span className="text-white">React</span>, and <span className="text-white">MongoDB</span>. Experienced in designing <span className="text-white">RAG</span> (Retrieval-Augmented Generation) pipelines, integrating Generative Model APIs (Gemini, LangChain), and building scalable, human-centric AI systems.
              </p>
              <p>
