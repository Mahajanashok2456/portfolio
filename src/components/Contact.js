...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-12 md:py-32 bg-black border-t border-white/5">
      <div className="max-w-[1440px] mx-auto px-6 md:px-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-24">
          ...
          >
            <h2 className="text-xs font-black text-white/40 uppercase tracking-[0.4em] mb-6">Start Your Project</h2>
            <h3 className="text-4xl md:text-8xl font-black text-white mb-6 md:mb-10 leading-[1.0] md:leading-[0.9] tracking-tighter uppercase">
              READY TO BUILD <br /> <span className="text-white/20">THE FUTURE?</span>
            </h3>
